"""
Django settings for ff_notes project.
...
SECRET_KEY = 'django-insecure-e=yl$o#f2%hd15&h3k7*w$5#qy+_9_#e2)--m)2$+a^**#8@bh'
...
WSGI_APPLICATION = 'ff_notes.wsgi.application'
